...
[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 499,707 | 🐛 106 | 📅 2026-08-21
...
* [AJAX Security Cheatsheet](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/AJAX_Security_Cheat_Sheet.md) ⭐ 32,972 | 🐛 64 | 🌐 Python | 📅 2026-08-25 - A starting point for AJAX security.
...
* [`dompurify`](https://github.com/cure53/DOMPurify) ⭐ 17,332 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - XSS sanitizer for HTML, MathML and SVG
...
* [Vulnerable Dependency Management](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.md#tools) ⭐ 32,972 | 🐛 64 | 🌐 Python | 📅 2026-08-25 - About tools for detecting vulnerable third-party dependencies.
