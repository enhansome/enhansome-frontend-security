...
[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,090 | 🐛 106 | 📅 2026-09-02
...
* [AJAX Security Cheatsheet](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/AJAX_Security_Cheat_Sheet.md) ⭐ 33,114 | 🐛 60 | 🌐 Python | 📅 2026-09-08 - A starting point for AJAX security.
...
* [`eslint-plugin-security`](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,374 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-05 - ESLint rules for Node Security.
* [`eslint-plugin-no-unsanitized`](https://github.com/mozilla/eslint-plugin-no-unsanitized) ⭐ 248 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-07 - ESLint rules to disallows unsafe innerHTML, outerHTML, insertAdjacentHTML and alike.
...
* [`dompurify`](https://github.com/cure53/DOMPurify) ⭐ 17,367 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-06 - XSS sanitizer for HTML, MathML and SVG
...
* [Vulnerable Dependency Management](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.md#tools) ⭐ 33,114 | 🐛 60 | 🌐 Python | 📅 2026-09-08 - About tools for detecting vulnerable third-party dependencies.
...
* [Awesome Web Security](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,776 | 🐛 3 | 🌐 Python | 📅 2026-09-05 - A curated list of Web Security materials and resources.
