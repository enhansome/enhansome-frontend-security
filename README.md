...
[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,670 | 🐛 100 | 📅 2026-06-30
...
* [AJAX Security Cheatsheet](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/AJAX_Security_Cheat_Sheet.md) ⭐ 32,907 | 🐛 75 | 🌐 Python | 📅 2026-08-17 - A starting point for AJAX security.
...
* [`dompurify`](https://github.com/cure53/DOMPurify) ⭐ 17,308 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-16 - XSS sanitizer for HTML, MathML and SVG
...
* [Vulnerable Dependency Management](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.md#tools) ⭐ 32,907 | 🐛 75 | 🌐 Python | 📅 2026-08-17 - About tools for detecting vulnerable third-party dependencies.
