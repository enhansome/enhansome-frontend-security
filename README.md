...
* [`dompurify`](https://github.com/cure53/DOMPurify) ⭐ 17,343 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - XSS sanitizer for HTML, MathML and SVG
* [`sanitize-html`](https://github.com/apostrophecms/sanitize-html) ⚠️ Archived - Clean up user-submitted HTML.

### Serializers

* [`serialize-javascript`](https://github.com/yahoo/serialize-javascript) ⭐ 2,922 | 🐛 45 | 🌐 JavaScript | 📅 2026-08-26 - Serialize JavaScript safely - HTML characters and JS line terminators are escaped automatically.
