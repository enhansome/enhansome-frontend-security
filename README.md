...
[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,647 | 🐛 106 | 📅 2026-09-02
...
* [AJAX Security Cheatsheet](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/AJAX_Security_Cheat_Sheet.md) ⭐ 33,135 | 🐛 62 | 🌐 Python | 📅 2026-09-08 - A starting point for AJAX security.
...
* [`eslint-plugin-security`](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,373 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-10 - ESLint rules for Node Security.
* [`eslint-plugin-no-unsanitized`](https://github.com/mozilla/eslint-plugin-no-unsanitized) ⭐ 248 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-08 - ESLint rules to disallows unsafe innerHTML, outerHTML, insertAdjacentHTML and alike.
...
* [`dompurify`](https://github.com/cure53/DOMPurify) ⭐ 17,373 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-09 - XSS sanitizer for HTML, MathML and SVG
* [`sanitize-html`](https://github.com/apostrophecms/sanitize-html) ⚠️ Archived - Clean up user-submitted HTML.

### Serializers

* [`serialize-javascript`](https://github.com/yahoo/serialize-javascript) ⭐ 2,922 | 🐛 43 | 🌐 JavaScript | 📅 2026-08-29 - Serialize JavaScript safely - HTML characters and JS line terminators are escaped automatically.

## Dependencies

* [Vulnerable Dependency Management](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.md#tools) ⭐ 33,135 | 🐛 62 | 🌐 Python | 📅 2026-09-08 - About tools for detecting vulnerable third-party dependencies.
...
* [Awesome Web Security](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,782 | 🐛 4 | 🌐 Python | 📅 2026-09-05 - A curated list of Web Security materials and resources.
