...
[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,652 | 🐛 107 | 📅 2026-09-02
...
* [AJAX Security Cheatsheet](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/AJAX_Security_Cheat_Sheet.md) ⭐ 33,309 | 🐛 56 | 🌐 Python | 📅 2026-09-24 - A starting point for AJAX security.
...
* [`eslint-plugin-security`](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,378 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-16 - ESLint rules for Node Security.
* [`eslint-plugin-no-unsanitized`](https://github.com/mozilla/eslint-plugin-no-unsanitized) ⭐ 249 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-08 - ESLint rules to disallows unsafe innerHTML, outerHTML, insertAdjacentHTML and alike.
...
* [`dompurify`](https://github.com/cure53/DOMPurify) ⭐ 17,412 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-25 - XSS sanitizer for HTML, MathML and SVG
* [`sanitize-html`](https://github.com/apostrophecms/sanitize-html) ⚠️ Archived - Clean up user-submitted HTML.

### Serializers

* [`serialize-javascript`](https://github.com/yahoo/serialize-javascript) ⭐ 2,923 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-23 - Serialize JavaScript safely - HTML characters and JS line terminators are escaped automatically.

## Dependencies

* [Vulnerable Dependency Management](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.md#tools) ⭐ 33,309 | 🐛 56 | 🌐 Python | 📅 2026-09-24 - About tools for detecting vulnerable third-party dependencies.
