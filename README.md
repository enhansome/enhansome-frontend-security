...
[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,423 | 🐛 106 | 📅 2026-09-02
...
* [AJAX Security Cheatsheet](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/AJAX_Security_Cheat_Sheet.md) ⭐ 33,089 | 🐛 58 | 🌐 Python | 📅 2026-09-05 - A starting point for AJAX security.
...
* [`dompurify`](https://github.com/cure53/DOMPurify) ⭐ 17,358 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-05 - XSS sanitizer for HTML, MathML and SVG
...
* [Vulnerable Dependency Management](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.md#tools) ⭐ 33,089 | 🐛 58 | 🌐 Python | 📅 2026-09-05 - About tools for detecting vulnerable third-party dependencies.
...
* [Awesome Web Security](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,773 | 🐛 1 | 🌐 Python | 📅 2026-09-05 - A curated list of Web Security materials and resources.
