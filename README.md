...
[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,837 | 🐛 105 | 📅 2026-08-21
...
* [AJAX Security Cheatsheet](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/AJAX_Security_Cheat_Sheet.md) ⭐ 33,038 | 🐛 62 | 🌐 Python | 📅 2026-09-01 - A starting point for AJAX security.
...
* [`eslint-plugin-security`](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,372 | 🐛 21 | 🌐 JavaScript | 📅 2026-08-20 - ESLint rules for Node Security.
...
* [`dompurify`](https://github.com/cure53/DOMPurify) ⭐ 17,351 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-29 - XSS sanitizer for HTML, MathML and SVG
...
* [Vulnerable Dependency Management](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.md#tools) ⭐ 33,038 | 🐛 62 | 🌐 Python | 📅 2026-09-01 - About tools for detecting vulnerable third-party dependencies.
...
* [Awesome Web Security](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,754 | 🐛 5 | 🌐 Python | 📅 2026-08-21 - A curated list of Web Security materials and resources.
