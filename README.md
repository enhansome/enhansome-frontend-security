...
[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,973 | 🐛 106 | 📅 2026-09-02
...
* [AJAX Security Cheatsheet](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/AJAX_Security_Cheat_Sheet.md) ⭐ 33,144 | 🐛 64 | 🌐 Python | 📅 2026-09-11 - A starting point for AJAX security.
...
* [`eslint-plugin-security`](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,374 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-10 - ESLint rules for Node Security.
...
* [`dompurify`](https://github.com/cure53/DOMPurify) ⭐ 17,377 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-09 - XSS sanitizer for HTML, MathML and SVG
...
* [Vulnerable Dependency Management](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.md#tools) ⭐ 33,144 | 🐛 64 | 🌐 Python | 📅 2026-09-11 - About tools for detecting vulnerable third-party dependencies.
...
* [Awesome Web Security](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,783 | 🐛 4 | 🌐 Python | 📅 2026-09-05 - A curated list of Web Security materials and resources.
