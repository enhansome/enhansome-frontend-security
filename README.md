...
[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,094 | 🐛 100 | 📅 2026-06-30
...
* [AJAX Security Cheatsheet](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/AJAX_Security_Cheat_Sheet.md) ⭐ 32,914 | 🐛 78 | 🌐 Python | 📅 2026-08-12 - A starting point for AJAX security.

### Linters

* [`eslint-plugin-security`](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,368 | 🐛 21 | 🌐 JavaScript | 📅 2026-08-11 - ESLint rules for Node Security.
...
* [`dompurify`](https://github.com/cure53/DOMPurify) ⭐ 17,300 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-13 - XSS sanitizer for HTML, MathML and SVG
...
* [Vulnerable Dependency Management](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.md#tools) ⭐ 32,914 | 🐛 78 | 🌐 Python | 📅 2026-08-12 - About tools for detecting vulnerable third-party dependencies.
* [`audit-ci`](https://github.com/IBM/audit-ci) ⭐ 297 | 🐛 19 | 🌐 TypeScript | 📅 2025-09-17 - NPM and Yarn dependencies audit for CI/CD.
...
* [Awesome Web Security](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,672 | 🐛 13 | 🌐 Python | 📅 2026-08-04 - A curated list of Web Security materials and resources.
