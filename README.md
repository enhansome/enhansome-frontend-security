...
[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,189 | 🐛 106 | 📅 2026-09-02
...
* [AJAX Security Cheatsheet](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/AJAX_Security_Cheat_Sheet.md) ⭐ 33,183 | 🐛 60 | 🌐 Python | 📅 2026-09-15 - A starting point for AJAX security.
...
* [`dompurify`](https://github.com/cure53/DOMPurify) ⭐ 17,389 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-14 - XSS sanitizer for HTML, MathML and SVG
...
* [Vulnerable Dependency Management](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.md#tools) ⭐ 33,183 | 🐛 60 | 🌐 Python | 📅 2026-09-15 - About tools for detecting vulnerable third-party dependencies.
